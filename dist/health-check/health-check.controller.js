...
const health_check_response_1 = require("./health-check.response/health-check.response");
let HealthCheckController = class HealthCheckController {
    healthCheck(res) {
        let response = new utils_response_common_1.ResponseData();
        response.setData(new health_check_response_1.HealthCheckResponse(process.env.CONFIG_BUILD_NUMBER, process.env.CONFIG_BUILD_TIME));
...
HealthCheckController = __decorate([
    (0, common_1.Controller)("/public/health-check")
